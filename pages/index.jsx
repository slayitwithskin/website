...
const index = () => {
  return (
    <>
      ...
      <Flex position={'relative'} p={16} bg={"#C5D8A4"} justifyContent={'space-between'}>
        ...
        <Flex>
          <iframe width="560" height="315" src="https://www.youtube.com/embed/q0BVR5jRXxE" title="YouTube video player" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </Flex>
      </Flex>

      <Flex pos={'relative'} h={'100vh'} mt={16} alignItems={'center'} justifyContent={'flex-start'}>
        <Box
          pos={'absolute'}
          t={0}
          l={0}
        ...
        >
          ...
          <Flex direction={'column'} alignItems={'flex-start'} justifyContent={'center'} w={'60%'} pl={16}>
            <Text className={styles.monts}>TALKS OF WISDOM</Text>
            <Text className={styles.cursive} fontSize={'56'}>Read Our Blogs</Text>
            <Box mt={6} mb={4} w={20} h={.5} bg={'blackAlpha.800'}></Box>
            <Text fontWeight={400}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore perspiciatis debitis iste quam repellendus quos, sapiente facilis! Consectetur voluptates deserunt sequi? Repudiandae recusandae, voluptas nesciunt non accusamus unde temporibus dolorum.</Text>
            <Link href={'#'} >
              <Flex mt={'12'} alignItems={"center"} justifyContent={"flex-start"}>
